...
% Long description
    ...
    while (length(ActiveLayer) ~= 0)
        ...
        for index = 1:length(ActiveLayer)
            ...
            %[MOS_SET, NeoCellList, del_set] = PortOrMerge(MOS_SET, Port_SET.content(Port_SET.FindId(CurrentPortId)).cell, CurrentPortId);
            ...
            [MOS_SET, Port_SET] = TopOrMerge(MOS_SET, Port_SET, CurrentPortId);
